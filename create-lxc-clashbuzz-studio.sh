#!/usr/bin/env bash
#
# create-lxc-clashbuzz-studio.sh — LXC Ubuntu 24.04 + ClashBuzz Studio
# (web UI admin de la bibliothèque de playlists, Node 22, repo tla1852/blindtest)
#
...
# - Puis : Node 22 (NodeSource), clone du repo blindtest (PAT demandé),
#          build apps/studio, service systemd (voir homelab/clashbuzz-studio/setup-app.sh)
#
...
# ----- Questions ----- (défauts skill : clashbuzz-studio / 1 / 1024)
read -rp "Nom du container (hostname) [clashbuzz-studio] : " CT_NAME; CT_NAME="${CT_NAME:-clashbuzz-studio}"
...
# ═════════════════════════════════════════════════════════════════════════════
# COUCHE APPLICATIVE — CLASHBUZZ STUDIO (le socle fournit git + user thibault)
# ═════════════════════════════════════════════════════════════════════════════
# Déléguée à homelab/clashbuzz-studio/setup-app.sh, relançable seul en cas d'échec :
